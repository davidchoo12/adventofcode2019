...
C = 'L,12,R,12,L,6\n'
video = 'n\n'
input_seq = [ord(char) for char in main + A + B + C + video]
i = -1
def input_handler():
  global i
  i += 1
...
def output_handler(output):
  if isinstance(output, int) and output < 0x110000:
